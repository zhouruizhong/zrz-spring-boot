...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara,String key) {
        ...
        if(AlipayConstant.sign_type.equals("MD5") ) {
        	mysign = MD5.sign(prestr, key, AlipayConstant.input_charset);
        }
        return mysign;
    }
	...
	public static String query_timestamp(String partner) throws MalformedURLException,
        ...
        String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + partner + "&_input_charset" +AlipayConstant.input_charset;
